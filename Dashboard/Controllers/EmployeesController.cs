...
namespace Dashboard.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Surname,Name,Patronymic,Position,Photo")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Surname,Name,Patronymic,Position,Photo")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
